...
import {convertDateToString, convertTimeToString} from '../../Shared/utils';
      ...
      style={[
        {
          height:
            size === 'small'
              ? getValue(type, 'textarea', 102, 38)
              : getValue(type, 'textarea', 112, 48),
        ...
        <View
          style={[
            styles.textInputLayout,
            {
              ...
              paddingRight:
                size === 'small'
                  ? getValue(type, 'datetime', 11 + 21, 11)
                  : getValue(type, 'datetime', 22 + 21, 22),
              width: '100%',
              height: '100%',
              position: 'relative',
            },
